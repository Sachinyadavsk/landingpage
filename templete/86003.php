...
if(!empty($rows)){
             ...
             <?php 
                    ...
                    <div class="hero-container margintop-lg">
                        <div class="hero-details hidden-mobile">
                            ...
                            <a href="<?php echo $rows_about['add_link'];?>">
                                <h3><?php echo $rows_about['title'];?></h3>
                            </a>
                            <p><?php echo $rows_about['short_desc'];?> </p>
                        </div>
                        <div class="hero-button hidden-mobile">
                            <a href="<?php echo $rows_about['add_link'];?>" class="portfolio-link"><?php echo $rows_about['button_url_name'];?> <i class="icon ion-md-add-circle"></i></a>
                        </div>
                        ...
                        <a href="<?php echo $rows_about['add_link'];?>" class="primary-btn mobile-only"><?php echo $rows_about['button_url_name'];?><i class="icon ion-md-add-circle"></i></a>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="portfolio-container">
                        <div class="portfolio-details">
                            <span>- Featured Project</span>
                            <a href="<?php echo $rows_features['add_link'];?>">
                                <h3><?php echo $rows_features['title'];?></h3>
                            </a>
                        </div>
                        <div class="portfolio-button">
                            <a href="<?php echo $rows_features['add_link'];?>" class="portfolio-link"><?php echo $rows_features['button_url_name'];?><i class="icon ion-md-add-circle"></i></a>
                        ...
                        <img src="../images/thema_gallery/<?php echo $rows_features['image']?>" class="img-fluid"
                            alt="<?php echo $rows_features['title'];?>" style="width:100%;height:500px">
                    </div>
                </div>
                 <?php 
                      }
    ...
    <section id="footer">
        <div class="container">
            ...
            <small><?php echo $rows['website_name'];?> <?php echo $endYear = date('Y');?> © Created by <a href="<?php echo $current_url;?>">Themes Dynimically </a></small>
        </div>
    </section>
    <?php
}else{
